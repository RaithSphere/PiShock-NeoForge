...
public final class PiShockCompat {
    // 1.21.11 uses Identifier in this mappings set, so this file stays separate from 1.21.10.
    private static final Identifier MAIN_MENU_ICON = Identifier.fromNamespaceAndPath(PiShock.MOD_ID, "pishock_setup");
    private static final KeyMapping.Category KEY_CATEGORY = KeyMapping.Category.register(
            Identifier.fromNamespaceAndPath(PiShock.MOD_ID, "controls")
    );
